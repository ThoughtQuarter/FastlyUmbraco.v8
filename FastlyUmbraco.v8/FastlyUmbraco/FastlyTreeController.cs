...
{
	[Tree("fastlyUmbraco", "Fastly", TreeTitle = "Overview", TreeGroup = "fastlyGroup", SortOrder = 0)]
	[PluginController("FastlyUmbraco")]
	public class FastlyTreeController : TreeController
	{
		protected override TreeNode CreateRootNode(FormDataCollection queryStrings)
		{
			...
			root.RoutePath = "fastlyUmbraco/Fastly/FastlyOverview";
